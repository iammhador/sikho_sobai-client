...
const SignIn = () => {
  ...
  return (
    <div>
      <div className="h-full bg-gradient-to-tl from-gray-300 to-indigo-700 w-full py-16 px-4">
        <div className="flex flex-col items-center justify-center">
          <img className="w-16" src={logo} alt="Sikho Sobai Logo" />
          <h2 className="text-3xl text-gray-50 ">Sikho Sobai</h2>
