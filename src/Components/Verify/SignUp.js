...
const SignUp = () => {
  ...
  const handleRegister = (e) => {
    ...
    registerWithEmailAndPassword(email, password)
      .then((result) => {
        console.log(result);
        toast.success("Successfully Sign Up Done");
        updateDisplayNameAndPhotUrl(fullName, photoURL)
          .then(() => {
            toast.success("Display Name & Photo Also Added");
          })
          .catch((error) => {
            toast.error(error);
          });
        verifyEmail().then(() => {
          toast.success("Email Verification Has Been Sended");
        });
      })
      .catch((error) => {
        console.error(error);
        ...
        <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
          ...
          <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
            <div className="flex items-center">
              ...
              <h2 className="text-4xl font-bold ml-2 text-rose-700">
                Sikho Sobai
              </h2>
            </div>
            <div className="flex items-start mt-8">
              ...
              <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">
                Sikho Sobai is a online education hub. I learn from them. They
                teach me very well. I worked in a market place and successfully
                completed two hundred jobs. I'm level two sellers in fiver. Now,
                I'm working at international IT company.
              </p>
            </div>
